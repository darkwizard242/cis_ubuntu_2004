...
def test_4_1_5_audit_rule_file_exists(host):
    host.file('/etc/audit/rules.d/4.1.5.rules').exists


def test_4_1_5_audit_rule_file_isfile(host):
    host.file('/etc/audit/rules.d/4.1.5.rules').is_file


def test_4_1_6_audit_rule_file_exists(host):
    host.file('/etc/audit/rules.d/4.1.6.rules').exists


def test_4_1_6_audit_rule_file_isfile(host):
    host.file('/etc/audit/rules.d/4.1.6.rules').is_file


def test_4_1_7_audit_rule_file_exists(host):
    host.file('/etc/audit/rules.d/4.1.7.rules').exists


def test_4_1_7_audit_rule_file_isfile(host):
    host.file('/etc/audit/rules.d/4.1.7.rules').is_file


def test_4_1_8_audit_rule_file_exists(host):
    host.file('/etc/audit/rules.d/4.1.8.rules').exists


def test_4_1_8_audit_rule_file_isfile(host):
    host.file('/etc/audit/rules.d/4.1.8.rules').is_file
